        ...
        <div class="contenidocuadro">
            ...
            if (isset($_POST['cambiarPass2'])) {
                ...
                if (password_verify($ver['pass'], $pass)) {
                    ...
                    mysqli_query($conn, "UPDATE users SET codeact='" . md5(rand(111111, 999999)) . "', pass='" .password_hash($npass, PASSWORD_DEFAULT) . "' WHERE nombre='" . $_SESSION['user'] . "'");
