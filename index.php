...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div class="cabecera">
            <div class="logo">
                <a href="/" title="Urbaloca - Tu chat virtual para conocer gente"><img src="/images/ullogo.png" alt="Urbaloca - Tu chat virtual para conocer gente" width="218" height="33" style="border: 0px;" /></a></div>
            <div class="menuitem">
                <a href="/laurba" title="UrbaLoca - Comunidad, eventos y concursos"><img src="/images/comunidad.png" alt="UrbaLoca - Comunidad, eventos y concursos" width="128" height="22" style="border: 0px;" /></a>
            </div>
            <div class="menuitem"><a href="/seguridad" title="UrbaLoca - Seguridad, moderadores y ayuda"><img src="/images/seguridad.png" alt="UrbaLoca - Seguridad, moderadores y ayuda" width="118" height="22" style="border: 0px;" /></a></div>
            <div class="menuitem"><a href="creditos" title="UrbaLoca - Creditos GRATIS para todos los usuarios!"><img src="/images/creditos.png" alt="UrbaLoca - Creditos GRATIS para todos los usuarios!" width="100" height="22" style="border: 0px;" /></a></div>
            <div class="menuitem2">
                <?
                if (isset($_SESSION['user'])) {
                    ?>
