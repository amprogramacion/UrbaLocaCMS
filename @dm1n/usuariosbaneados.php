  ...
  <tr>
    ...
    <td bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="98%" align="center" bgcolor="#FF5353" style="text-shadow: 0.11em 0.11em #333; color:#FFFFFF; font-weight:bold;">Banear/Desbanear USUARIO </td>
      ...
      <tr>
        <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="7">
          <tr>
            <td><p>Banea y desbanea a un usuario:</p>
              <form id="form1" name="form1" method="post" action="">
                <table width="569" border="0" align="center">
                  <tr>
                    <td width="145" align="right"><strong>Usuario:</strong></td>
                    <td width="414"><label>
                      <input name="user" type="text" id="user" value="<?=$_GET['user'];?>" />
                    </label></td>
                  </tr>
                  <tr>
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td bgcolor="#DADADA"><table width="100%" border="0">
                    <tr>
                      <td width="17%" align="center"><?=$ver_b['nombre'];?></td>
                      <td width="14%" align="center"><?=date('d-m-Y - H:m:s', $ver_b['fechaban']);?></td>
                      <td width="57%" align="center"><span class="Estilo1">
                        <?=$ver_b['motivo'];?>
                      </span></td>
                      <td width="12%" align="center"><a href="desbanear.php?id=<?=$ver_b['id'];?>">Desbanear</a></td>
                    </tr>
                  </table></td>
