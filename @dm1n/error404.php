  ...
  <tr>
    ...
    <td bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="98%" align="center" bgcolor="#FF5353" style="text-shadow: 0.11em 0.11em #333; color:#FFFFFF; font-weight:bold;">Error 404 - Archivo no encontrado </td>
      ...
      <tr>
        <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="7">
          <tr>
            <td><p>El archivo solicitado no existe en nuestros servidores.</p>
              <p><em>Disculpa las molestias.  </em></p></td>
          </tr>
        </table></td>
      </tr>
    </table></td>
