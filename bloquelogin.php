...
if (!isset($_SESSION['user'])) {
    ...
    <div class="entraya">
        ...
        <a href="/game" target="_blank" onClick="window.open(this.href, this.target, 'width=980,height=610'); return false;"><img src="images/enterul.png" width="381" height="122" style="border: 0px;" alt="" /></a>
